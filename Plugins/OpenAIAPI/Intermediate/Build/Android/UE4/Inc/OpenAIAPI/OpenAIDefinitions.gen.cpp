...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_OpenAIAPI_EOAEngineType_Hash() { return 365494170U; }
	UEnum* Z_Construct_UEnum_OpenAIAPI_EOAEngineType()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EOAEngineType::DAVINCI_INSTRUCT_BETA", (int64)EOAEngineType::DAVINCI_INSTRUCT_BETA },
				{ "EOAEngineType::CURIE_INSTRUCT_BETA", (int64)EOAEngineType::CURIE_INSTRUCT_BETA },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "ADA.Name", "EOAEngineType::ADA" },
				{ "ADA.ToolTip", "Ada is usually the fastest model and can perform tasks like parsing text, address correction and certain kinds of classification tasks that don?t require too much nuance. Ada?s performance can often be improved by providing more context." },
				{ "BABBAGE.Name", "EOAEngineType::BABBAGE" },
				{ "BABBAGE.ToolTip", "Babbage can perform straightforward tasks like simple classification. It?s also quite capable when it comes to Semantic Search ranking how well documents match up with search queries." },
				{ "BlueprintType", "true" },
				...
				{ "DAVINCI_INSTRUCT_BETA.Name", "EOAEngineType::DAVINCI_INSTRUCT_BETA" },
				{ "DAVINCI_INSTRUCT_BETA.ToolTip", "The Instruct series is better at understanding and following your instructions. Simply tell the API what you want it to do, and it will; you don?t have to rely on providing ?illustrative examples? or spending lots of time engineering your prompt. Write your instructions in clear English, as if you were instructing a human to do the task." },
...
static struct FScriptStruct_OpenAIAPI_StaticRegisterNativesFGPT3Settings
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FGPT3Settings_Statics::NewProp_startSequence_MetaData[] = {
		{ "Category", "OpenAI" },
		{ "Comment", "/** A sequence that is used at the start of the prompt */" },
		{ "ModuleRelativePath", "Public/OpenAIDefinitions.h" },
		{ "ToolTip", "A sequence that is used at the start of the prompt" },
	};
#endif
	...
	uint32 Get_Z_Construct_UScriptStruct_FGPT3Settings_Hash() { return 2745667739U; }
...
static struct FScriptStruct_OpenAIAPI_StaticRegisterNativesFCompletionInfo
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FCompletionInfo_Hash() { return 3711117087U; }
